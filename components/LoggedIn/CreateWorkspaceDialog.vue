<template>
  <DialogContent
    class="bg-white dark:bg-[#22272B] !p-0 border-none flex lg:!max-w-[1200px] !min-h-[700px] flex-col-reverse lg:flex-row !max-w-[475px] mt-20 lg:mt-0 overflow-hidden top-[45%] rounded-[2px]">

    <div class="w-full lg:w-[50%] mt-[64px] mx-auto flex flex-1 items-center flex-col px-[24px]">
