<template>
  <div class="md:grid md:grid-cols-4 mt-16 md:divide-x-2 ">
    <div class=" priceCompareItem !border-r-0">
      <p>FREE</p>
    ...
    <div class="priceCompareItem md:border-2 md:border-cyan-500">
      <p>PREMIUM</p>
      <p>$<span class="text-4xl">10</span>USD</p>
    ...
    <div class="priceCompareItem  md:border-l-cyan-500 md:!border-r-2">
      <p>ENTERPRISE</p>
