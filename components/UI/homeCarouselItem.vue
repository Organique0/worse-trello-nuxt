<template>
  <div class="homeCarouselItem h-60 w-80 overflow-hidden text-left relative my-14" style="border-radius: 1em;">
    ...
    <div class="pt-8 py-11">
      <h1 class="font-lg font-bold pb-4">{{ props.title }}</h1>
      <p>{{ props.body }}</p>
    </div>
  </div>
</template>
