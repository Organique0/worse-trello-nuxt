<template>
	<div
		class="w-full h-full dark:backdrop-brightness-75"
		v-if="boardData"
	>
		<div
...
<script lang="ts" setup>
	...
	import type { FullBoard, Pallete } from "~/lib/types";
	...
	onBeforeMount(async () => {
		...
		boardData.value = myWorkspaceStore.getBoardById(route.params.bid as string);
	});
