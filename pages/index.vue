<template>
	<div>
		<div
			class="bg-gradient-to-r from-purple-800 to-pink-500 w-full h-[53em] pt-16 relative"
		>
			<div
				class="bg-cover bg-center bg-whiteCurves absolute bottom-[-17px] w-full h-[25%]"
			></div>
			<div class="mx-auto md:pl-[1rem] md:pr-[1rem] max-w-[1140px] px-[1rem]">
				<div class="items-center justify-center flex flex-wrap">
					<div class="lg:pt-32 text-white md:flex-1 pt-24">
						...
						<h3 class="lg:my-12 md:my-8 font-semibold lg:text-2xl md:text-xl">
					...
					<div
						class="sm:ml-11 relative block md:flex-1 text-center pt-8 md:pt-32 mb-0 pb-0 mt-0"
					>
						<NuxtImg
							format="webp"
		...
		<div class="">
			<div class="homeCenterContainer">
				<div class="relative text-left order-1 w-full block pt-12">
					...
					<h1 class="customTitle mt-2 mb-4">
			...
			<div class="hidden lg:flex justify-end homeCenterContainer">
				<div
					@click="goBackwardNew"
					class="bg-gray-200 text-gray-800 hover:bg-gray-300 rounded-full mr-7 w-9 h-9"
				>
					<Icon
				...
				<div
					@click="goForwardNew"
					class="bg-gray-200 text-gray-800 hover:bg-gray-300 rounded-full w-9 h-9"
				>
					<Icon
			...
			<div
				class="w-full overflow-hidden hidden lg:block"
			...
			>
				<div
					class="md:mb-8 homeCenterContainer transition-all ease-out duration-700"
					:style="mxValue"
					...
					>
						...
						<template #indicator="{ onClick, page, active }">
							<UButton
								...
								class="rounded-full justify-center w-1/6 h-5"
								@click="onClick(page)"
			...
			<div class="homeCenterContainer pt-11">
				<div class="block sm:flex">
					<p
						class="w-full leading-loose font-medium text-lg sm:w-[70%] sm:mr-auto"
					>
		...
		<div
			class="bg-gradient-to-l from-cyan-500 to-blue-500 h-[85em] relative md:h-[62em]"
		>
			<div
				class="absolute left-16 w-1/6 h-full bg-cover bg-center bg-viewsBgLeft"
			></div>
			<div
				class="absolute right-16 w-1/6 h-full bg-cover bg-center bg-viewsBgRight"
			></div>
			<div class="homeCenterContainer">
				<!--HEADER-->
				<div class="text-center pt-14 text-white">
					...
					<UButton
						...
						variant="solid"
						size="md"
						class="p-[1em] ring-blue-700 mt-4"
					>
		...
		<div class="bg-gradient-to-t from-white to-wierdGreen h-auto">
			...
			<div class="homeCenterContainer">
				<div class="pt-16 flex flex-col items-center gap-y-3">
					...
					<h3
						class="md:text-xl font-medium text-wierdBlue text-lg leading-8 text-center"
					>
		...
		<div class="homeCenterContainer">
			<div class="ml-[8%] w-[83%] my-14">
				<h3 class="text-center font-medium text-2xl leading-8 my-8">
